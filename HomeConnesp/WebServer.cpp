...
<body>
    ...
    <nav class="sidebar">
        <div
            style="font-size:1.2rem;font-weight:700;color:#818cf8;margin-bottom:24px;display:flex;align-items:center;gap:8px">
            <span class="material-icons">home</span> HomeConnesp
        </div>
        <div class="nav-item active" onclick="showPage('dashboard',this)"><span
                class="material-icons">dashboard</span>Dashboard</div>
        <div class="nav-item" onclick="showPage('performance',this)"><span
                class="material-icons">speed</span>Performance</div>
        <div class="nav-item" onclick="showPage('logs',this)"><span class="material-icons">article</span>Logs</div>
        <div class="nav-item" onclick="showPage('control',this)"><span class="material-icons">toggle_on</span>Controle
        </div>
    ...
    <main class="main-content">
        ...
        <div id="page-performance" class="page">
            ...
            <div class="grid">
                <div class="card s12 m6 l3" style="text-align:center">
                    <div class="metric-val" id="p-cpu">--%</div>
                    <div class="metric-lbl">CPU Load</div>
                </div>
                <div class="card s12 m6 l3" style="text-align:center">
                    <div class="metric-val" id="p-heap-free">--</div>
                    <div class="metric-lbl">Heap Livre (B)</div>
                </div>
                <div class="card s12 m6 l3" style="text-align:center">
                    <div class="metric-val" id="p-heap-min">--</div>
                    <div class="metric-lbl">Heap Mín. (B)</div>
                </div>
                <div class="card s12 m6 l3" style="text-align:center">
                    <div class="metric-val" id="p-flash">--</div>
                    <div class="metric-lbl">Flash Usada (KB)</div>
                </div>
            </div>
            <div class="grid">
        ...
        <div id="page-control" class="page">
            ...
            <div class="grid">
                <div class="card s12 m6">
                    ...
                    <div style="margin:20px 0;font-size:.9rem;color:#94a3b8">Estado atual: <span id="c-relay-state"
        ...
        <div id="page-config" class="page">
            ...
            <div class="card">
                <fieldset>
                    ...
                    <div>Intervalo de leitura (ms): <span id="cfg-interval-val">2000</span></div>
    ...
    <script>
        ...
        function mkLineChart(id, label, color) {
            ...
            return new Chart(ctx, {
                ...
                options: {
                    animation: false, plugins: { legend: { labels: { color: '#94a3b8' } } }, scales: {
        ...
        function mkBarChart(id, labels, datasets) {
            ...
            return new Chart(ctx, {
                ...
                options: {
                    animation: false, indexAxis: 'y', plugins: { legend: { labels: { color: '#94a3b8' } } }, scales: {
